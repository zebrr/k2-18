...
import { NodeExplorer } from './node_explorer.js';
import { EdgeInspector } from './edge_inspector.js';
...
export function init(graphData, conceptData) {
...
// Export ViewerCore for debugging
export { ViewerCore };