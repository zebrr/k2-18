...
const Formatters = {
    ...
    init() {
        ...
        // MathJax configuration is now set in HTML template before loading the library
    ...
    formatNodeText(text) {
        ...
        // 2. Process math expressions for MathJax
        // Convert $...$ to \(...\) and $$...$$ to \[...\]
        ...
        // 3. Code highlighting will be done after DOM insertion
        // 4. Math rendering will be triggered after DOM insertion
