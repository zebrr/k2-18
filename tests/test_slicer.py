...
class TestPreprocessText:
    ...
    def test_invalid_input(self):
        ...
        with pytest.raises(ValueError, match="Входной параметр должен быть строкой"):
            preprocess_text(123)
...
class TestValidateConfigParameters:
    ...
    def test_missing_slicer_section(self):
        ...
        with pytest.raises(ValueError, match="Отсутствует обязательный параметр slicer.max_tokens"):
    ...
    def test_missing_required_param(self):
        ...
        with pytest.raises(ValueError, match="Отсутствует обязательный параметр slicer.overlap"):
            validate_config_parameters(config)
    ...
    def test_invalid_max_tokens(self):
        ...
        with pytest.raises(ValueError, match="должен быть положительным целым числом"):
            validate_config_parameters(config)
    ...
    def test_invalid_overlap(self):
        ...
        with pytest.raises(ValueError, match="должен быть неотрицательным целым числом"):
            validate_config_parameters(config)
    ...
    def test_overlap_greater_than_max_tokens(self):
        ...
        with pytest.raises(ValueError, match="должен быть меньше max_tokens"):
            validate_config_parameters(config)
    ...
    def test_overlap_validation_with_shift(self):
        ...
        with pytest.raises(ValueError, match="не должен превышать overlap\\*0\\.8"):
            validate_config_parameters(config)
    ...
    def test_empty_allowed_extensions(self):
        ...
        with pytest.raises(ValueError, match="должен быть непустым списком"):
            validate_config_parameters(config)
