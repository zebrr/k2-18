...
from utils.llm_embeddings import EmbeddingsClient, get_embeddings, cosine_similarity_batch
...
class TestTPMLimits:
    ...
    def test_large_volume_processing(self, client):
        ...
        texts = []
        for i in range(50):
            texts.append(f"This is a longer test text number {i} with more content to consume tokens.")
